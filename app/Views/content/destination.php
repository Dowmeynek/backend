            ...
            <?php foreach ($destinations as $destination): ?>
                <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                    <a class="position-relative d-block overflow-hidden" href="">
                        <img class="w-100" src="<?= $destination['image']?>" alt="<?= $destination['name']?>">
                        <div class="bg-white text-danger fw-bold position-absolute top-0 start-0 m-3 py-1 px-2"><?= $destination['price']?></div>
